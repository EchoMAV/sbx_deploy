...
gst-launch-1.0 v4l2src device=/dev/$deviceId ! videoconvert ! x264enc tune=zerolatency bitrate=1024 ! rtph264pay config-interval=1 pt=96 ! udpsink host=${LOS_HOST} port=${LOS_SEEK_PORT} async=false sync=false &
